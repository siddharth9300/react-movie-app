...
<section className="text-gray-600 body-font pb-12  dark:bg-slate-900">
  <div className="container px-5 py-12 mx-auto ">
    <div className="flex flex-col text-center w-full mt-16 max-md:mt-24">
      ...
      <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium dark:text-white text-gray-900">Your Todo List</h1>
    ...
    <img className="w-64 mb-10 ml-12 max-md:w-32 object-cover object-center rounded" alt="hero" src="./notes.png"/>
      <p className="mb-8 w-3/6 max-md:w-5/6 leading-relaxed dark:text-gray-200">This is a todo list manager made by react and tailwind css source code can be find by clicking below button.</p>
    </div>

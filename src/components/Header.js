    ...
    <header className="text-gray-600 body-font font-body fixed  z-10 w-full bg-white dark:bg-slate-900 md:border-b md:border-gray-400 dark:max-md:shadow-white shadow dark:md:shadow-white md:shadow-black/20">
      <div className="container mx-auto ml-10 flex max-md:ml-3 max-md:mb-1 max-md:px-2 max-md:py-3 flex-wrap p-5 md:flex-row ">
        ...
        <nav className="md:mr-auto  sm:mt-2 flex flex-wrap max-sm:mx-auto max-md:mt-0 max-md:mx-0 text-base dark:text-gray-200 justify-center ">
          ...
          <Link className="mr-5 max-md:mr-3 main-font hover:text-gray-900  dark:hover:text-gray-400" to="/">
            Home
          </Link>
          <Link className="mr-5 max-md:mr-3 main-font hover:text-gray-900 dark:hover:text-gray-400" to="/PopularMovies">
          Top 20 Movies
          </Link>
          <Link className="mr-5 max-md:mr-3 main-font hover:text-gray-900 dark:hover:text-gray-400" to="/PopularTv">
          Top 20 Tv Series
          </Link>
          <Link className="mr-5 max-md:mr-3 main-font hover:text-gray-900 dark:hover:text-gray-400" to="/Favourites">
          Favourites
          </Link>
          <Link className="mr-5 max-md:mr-3 main-font hover:text-gray-900 dark:hover:text-gray-400" to="/about">
            About
          </Link>

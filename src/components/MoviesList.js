                    ...
                    <div class="max-md:w-96  sm:max-w-xl w-max">
                      <div class="dark:bg-white bg-gray-200 shadow-lg border-gray-100 h-96  border max-md:rounded-3xl sm:rounded-3xl p-8 flex space-x-8">
                        ...
                        <div class="max-md:w-5/6 overflow-visible w-3/6">
                            <img class="rounded-3xl mt-4 shadow-lg" src={`https://image.tmdb.org/t/p/original${movie && movie.poster_path}`} alt=""/>
                        ...
                        <div class="flex flex-col w-3/4 space-y-4">
                          ...
                          <Link to={`/movie/${movie.id}`}>
                            <h2 class="text-3xl max-md:text-2xl font-bold hover:text-gray-600">{movie.original_title}</h2>
                            </Link>
                          ...
                          <div>
                            ...
                            <p class=" text-gray-600 max-h-40 max-md:text-sm overflow-y-hidden">{movie.overview}</p>
